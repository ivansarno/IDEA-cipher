...
IdeaCipher -k: create a 128 bits key and a 64 bit nonce ad store these in a file called output in the current directory.\n \
IdeaCipher -e inputFile keyFile: encrypt inputFile and create the ouptput file in the current directory. keyFile contains a 172 \random bit for key and nonce.\n \
IdeaCipher -e inputFile: encrypt inputFile and create the ouptput file and key file in the current directory, key file contains a 172 random bit for key and nonce.\n \
IdeaCipher -d inputFile keyFile: decrypt inputFile and create the ouptput file in the current directory. keyFile contains a 172 \random bit for key and nonce.\n";
