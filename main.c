...
int main(int argc, const char * argv[]) {
    ...
    typeint2 key2[]=/*{0x0960, 0x0af0, 0x0c80, 0x0190, 0x0320, 0x04b0};{0xb005, 0x7806, 0x4000, 0xc801, 0x0640, 0x07d0};*/{0x0064, 0x00c8, 0x012c, 0x0190, 0x01f4, 0x0258, 0x02bc, 0x0320};
